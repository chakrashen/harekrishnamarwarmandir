      ...
      <div className={`${styles.topBar} ${topBarVisible ? '' : styles.topBarHidden}`}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div className={styles.topBarLeft}>
            ...
            <a href="https://wa.me/919929945107" className={styles.topBarLink} target="_blank" rel="noopener noreferrer">
              <MessageCircle size={14} aria-hidden="true" />
              <span>WhatsApp</span>
            </a>
            <a href="tel:+919929945107" className={styles.topBarLink}>
              <Phone size={14} aria-hidden="true" />
              <span>+91 99299 45107</span>
            </a>
          </div>
